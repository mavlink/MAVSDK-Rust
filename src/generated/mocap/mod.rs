...
impl Mocap {
    ...
    pub fn set_vision_position_estimate(&self, vision_position_estimate: mocap::VisionPositionEstimate) -> MocapResult {
    ...
    pub fn set_attitude_position_mocap(&self, attitude_position_mocap: mocap::AttitudePositionMocap) -> MocapResult {
